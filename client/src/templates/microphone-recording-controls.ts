export function renderMicrophoneRecordingControls(): string {
  return /*html*/ `
    ...
    >
      ...
      <div class="microphone-recording__review-layout">
        <div id="microphone-take-review" class="microphone-recording__review" hidden>
          ...
          <button id="microphone-discard-button" class="button button--danger microphone-recording__discard" type="button" aria-label="Discard take" disabled hidden>Discard</button>
        </div>
        ...
        >
          <summary class="microphone-recording__alignment-header">
            <strong id="microphone-alignment-heading">Set Recording Alignment</strong>
            <span id="microphone-alignment-value">Offset: 0ms</span>
          </summary>
          <div class="microphone-recording__alignment-actions">
            <button id="microphone-alignment-earlier-100" class="button button--secondary" type="button" aria-label="Move recording 100 ms earlier">-100 ms</button>
            <button id="microphone-alignment-earlier-10" class="button button--secondary" type="button" aria-label="Move recording 10 ms earlier">-10 ms</button>
            <button id="microphone-alignment-earlier-1" class="button button--secondary" type="button" aria-label="Move recording 1 ms earlier">-1 ms</button>
            <button id="microphone-alignment-reset" class="button button--secondary" type="button">Reset</button>
            <button id="microphone-alignment-later-1" class="button button--secondary" type="button" aria-label="Move recording 1 ms later">+1 ms</button>
            <button id="microphone-alignment-later-10" class="button button--secondary" type="button" aria-label="Move recording 10 ms later">+10 ms</button>
            <button id="microphone-alignment-later-100" class="button button--secondary" type="button" aria-label="Move recording 100 ms later">+100 ms</button>
          </div>
          <p class="microphone-recording__alignment-hint">Negative = earlier · Positive = later · Reset = 0 ms</p>
        </details>
      </div>
